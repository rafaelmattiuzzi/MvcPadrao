...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo BASE_SITE('assets/css/style_painel.css'); ?>" />
</head>
<body>
	...
	<script type="text/javascript" src="<?php echo BASE_SITE('assets/js/script_painel.js'); ?>"></script>
</body>
</html>